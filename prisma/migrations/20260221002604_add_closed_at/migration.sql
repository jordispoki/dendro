...
INSERT INTO "new_Conversation" ("branchMessageId", "branchSummary", "branchText", "createdAt", "deletedAt", "id", "model", "parentId", "title", "treeId") SELECT "branchMessageId", "branchSummary", "branchText", "createdAt", "deletedAt", "id", "model", "parentId", "title", "treeId" FROM "Conversation";
