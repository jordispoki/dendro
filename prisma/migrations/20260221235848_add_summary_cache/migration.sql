...
INSERT INTO "new_Conversation" ("branchMessageId", "branchSummary", "branchText", "closedAt", "createdAt", "deletedAt", "id", "model", "parentId", "title", "treeId", "verbosity") SELECT "branchMessageId", "branchSummary", "branchText", "closedAt", "createdAt", "deletedAt", "id", "model", "parentId", "title", "treeId", "verbosity" FROM "Conversation";
