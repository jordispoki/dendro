...
INSERT INTO "new_UserSettings" ("defaultBranchModel", "defaultBranchVerbosity", "defaultConvModel", "defaultConvVerbosity", "enabledModels", "id", "localExecutionEnabled", "streamingEnabled", "systemPrompt", "userId") SELECT "defaultBranchModel", "defaultBranchVerbosity", "defaultConvModel", "defaultConvVerbosity", "enabledModels", "id", "localExecutionEnabled", "streamingEnabled", "systemPrompt", "userId" FROM "UserSettings";
