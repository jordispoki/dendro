...
INSERT INTO "new_UserSettings" ("defaultBranchModel", "defaultBranchVerbosity", "defaultConvModel", "defaultConvVerbosity", "enabledModels", "id", "localExecutionEnabled", "streamingEnabled", "systemPrompt", "urlFetchSameDomain", "userId") SELECT "defaultBranchModel", "defaultBranchVerbosity", "defaultConvModel", "defaultConvVerbosity", "enabledModels", "id", "localExecutionEnabled", "streamingEnabled", "systemPrompt", "urlFetchSameDomain", "userId" FROM "UserSettings";
