...
CREATE TABLE "new_UserSettings" (
    ...
    "sshConfigPath" TEXT NOT NULL DEFAULT '',
    "urlFetchSameDomain" BOOLEAN NOT NULL DEFAULT false,
    "homeLayout" TEXT NOT NULL DEFAULT 'select',
    CONSTRAINT "UserSettings_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_UserSettings" ("defaultBranchModel", "defaultBranchVerbosity", "defaultConvModel", "defaultConvVerbosity", "enabledModels", "homeLayout", "id", "localExecutionEnabled", "remoteHosts", "streamingEnabled", "systemPrompt", "urlFetchSameDomain", "userId") SELECT "defaultBranchModel", "defaultBranchVerbosity", "defaultConvModel", "defaultConvVerbosity", "enabledModels", "homeLayout", "id", "localExecutionEnabled", "remoteHosts", "streamingEnabled", "systemPrompt", "urlFetchSameDomain", "userId" FROM "UserSettings";
